defmodule Stick.ProfilesTest do
  use Stick.DataCase
  ...
  describe "profiles" do
    ...
    test "create_profile/1 with valid data creates a profile" do
      ...
      assert profile.can_close_tickets == true
      assert profile.can_open_ticket == true
    ...
    test "update_profile/2 with valid data updates the profile" do
      ...
      assert profile.can_close_tickets == false
      assert profile.can_open_ticket == false
