defmodule StickWeb.UserAuthTest do
  use StickWeb.ConnCase, async: true

  alias Stick.Accounts
  alias StickWeb.UserAuth
  import Stick.AccountsFixtures

  @remember_me_cookie "_stick_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, StickWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      StickWeb.Endpoint.subscribe(live_socket_id)
